...
const App = () => {
    return (
        <div className="bg-np-repeat min-h-screen bg-gray-300  bg-[url('./assets/images/bg-mobile-light.jpg')] bg-contain bg-no-repeat">
            ...
            <p className="mt-8 text-center">drop and drop</p>
        </div>
    );
};
